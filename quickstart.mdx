---
title: "Weekly Breakdown & Deliverables"
...
<Steps>
  <Step title="Week 1: Onboarding Process" stepNumber={1}>
    ...
    <Check>
      **Deliverables**: Good vibes, understanding of the platform/internal processes
    </Check>
  </Step>
  <Step title="Week 2: Research + Discovery">
    ...
    - Update content pillars/content format mix. Potential examples (TBD):
      - Social proof (ie. customer spotlights, case studies, dev/PM/CTO interviews & testimonials)
      - Business impact (ie. how to reduce onboarding churn, how to decrease support ticket volume, scaling documentation for growth, SEO/GEO optimization, etc.)
      - Dev Experience (ie. listicles, comparisons with competitors, use cases)
      - Thought leadership (ie. founder stories, company updates/feature announcements, AI trends in documentation, future of dev tools, documentation best practices, etc.)
  ...
  <Step title="Week 4: Consistency + Testing">
    ...
    - Beginning research and early outreach for approved co-marketed content like executive interviews, customer success stories, co-authored industry analysis/best practices guides, etc.)
  ...
  <Step title="Week 5-6: Testing + Optimization">
    ...
    - Schedule 2-3 initial conversations or interviews for co-marketing efforts
